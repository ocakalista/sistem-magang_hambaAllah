...
class _StudentsScreenState extends State<StudentsScreen> {
  ...
  Widget build(BuildContext context) {
    final state = NexusScope.of(context);
    final students = _filteredStudents.isEmpty && _searchController.text.isEmpty
              ...
              child: students.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final status = _getStatusLabel(student.progressPercent);
                        final statusColor =
                            _getStatusColor(student.progressPercent);
